...
Bienvenido a 4biz Versión 8.0.5.3. Esta versión presenta las siguientes mejoras:
...
Bienvenido a 4biz Versión 8.0.5.2. Esta versión presenta las siguientes mejoras:
...
Bienvenido a 4biz Versión 8.0.5.1. Esta versión presenta las siguientes mejoras:
...
|5569|[ITSM 1652] – Fallo en el Tasker de Problema, Cambio y Liberación al crear un Workspace, las Sprints se sobrescriben.|
...
|Item|Descripción|
|--------|---------|
|5407|Tasker – La funcionalidad no permitía descargar archivos adjuntos desde tarjetas del Tasker|
...
Bienvenido a 4biz Versión 8.0.1.2. Esta versión tiene las siguientes correcciones.
...
Bienvenidos a 4biz Versión 8.0.1.1. Esta versión contiene las siguientes correcciones.
...
Bienvenidos a 4biz Versión 8.0.1.0. La versión 8.0.1.0 de 4biz presenta las siguientes mejoras:
...
|2584|Tasker - El administrador de los sprints puede asignar a un usuario específico acceso de gestor de un Sprint.|
|2134|Tasker - Restricción para editar el perfil de acceso de Administrador.|
|837|Tasker – Presentación del cuantitativo de tareas por lista en Sprint|
...
|2588|Tasker – Búsqueda por parte de los títulos de las workspaces, sprints y tareas.|
