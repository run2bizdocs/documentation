...
!!! Question "¿Es posible clasificar la Solicitud/Incidente (Ticket)?"
    ...
    Tanto una Solicitud como un Incidente pueden ser categorizados en la etapa de [registro de las actividades en un servicio](https://docs.run2biz.com/es-es/4biz-helium/processes/portfolio-and-catalog/use/register-service-activity.html), las categorías se pueden crear en la misma pantalla de registro, en la hora del enlace de la categoría o en las funcionalidades específicas para [Crear categoría de servicio](/es-es/4biz-helium/processes/portfolio-and-catalog/configuration/create-service-category.html).    
...
!!! Question "¿Cómo configurar la respuesta automática de encuestas de satisfacción?"
    ...
    3- Se mostrará la pantalla de registro de procesamiento por lotes, complete los siguientes campos con la respectiva información:
      ...
      - Contenido: informe el texto: br.com.4biz.citcorpore.quartz.job.AvaliarSolicitacoesNoRespuestas;
