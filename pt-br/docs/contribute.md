...
As documentações do 4biz estão disponíveis publicamente no [GitHub](https://github.com/citsmartdocs/). É através dele que você conseguirá editar os documentos existentes, criar novos documentos ou mesmo sugerir melhorias para nosso portal.
...
1) Acesse o repositório de documentos da 4biz no GitHub: https://gitbub.com/citsmartdocs.
