Description: Release Notes 4biz Versão 8.0.0.0 de 01/03/2019
...
**O usuário visualiza somente os ícones dos processos que o mesmo possui acesso com exceção dos ícones Tasker, Portal do Conhecimento, Centro de Experiência e Guia de Usuário.**
...
Para mais informações, veja [Tasker][15]
...
A partir da versão 1.2.3.0 do Builder é possível criar automaticamente um questionário do 4biz a partir do cadastro de objeto de negócio do Builder. A ideia dessa inovação é facilitar a extração de respostas de questionários do 4biz e formar relatórios de forma Taskers com o auxílio do Smart Report.
