...
- [X] É necessário ter implantada a versão do 4biz Inventory 1.2.1.9 ou superior (ver [Realizar a instalação][1]);
...
- [X] Ter um processo de inverário definido via Gerência de Configuração (ver [Implementar o 4biz Inventory][3]);
...
[1]:/pt-br/4biz-helium/get-started/installation-and-upgrade/perform-installation.html
[2]:/pt-br/4biz-helium/get-started/installation-and-upgrade/perform-installation.html#configuracao-do-system-properties
[3]:/pt-br/4biz-helium/additional-features/add-ons/inventory.html
