...
Atualmente, a leitura de dados em um servidor AD/LDAP se resume ao objeto "usuário". Dessa forma, você pode usar filtros para trazê-los para o 4biz. Além disso, você pode utilizar a opção "Mapeamento de campos" para carregar informações de atributos (ex.: e-mail, telefone, localidade etc.).
...
![Autenticação 4biz LDAP](images/cloud-arch-authentication.png)
...
[2]:/pt-br/4biz-helium/processes/event/configuration/register-time.html
