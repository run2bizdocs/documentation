...
|5373|Create native webservices in 4biz tracker|
...
| 1910       | Message is not internationalized (Depends on Tasker \# 2878)                                                                                                                                                                                                 | Corrective   |
...
|New|Builder|From the version 1.2.3.0 of Builder, it's possible to automatically create a 4biz questionnaire from the Builder business object register. The idea behind this innovation is to facilitate the extraction of responses from 4biz questionnaires and to create reports in a Tasker way, with the help of the Smart Report.|
