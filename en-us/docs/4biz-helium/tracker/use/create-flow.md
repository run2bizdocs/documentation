...
Description: It's possible to create trackers that best fit to the users' reality

# Create tracker

 It's possible to create trackers that best fit to the users' reality, customizing the scenario of each organization.
...
[2]:/en-us/4biz-helium/tracker/configuration/expressions-creator.html
