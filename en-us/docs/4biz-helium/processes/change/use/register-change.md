...
|Importance|Importance level of change, we have the options: 
**Important** involve a significant amount of preparation and work with complex situations or major,
**Significant**Significant change; Significant changes involve preparation and work, evaluation, authorization and planning for change. 
Examples:
